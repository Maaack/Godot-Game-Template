...
- `option_control.tscn` and its inherited scenes are used for most configurable options in the menus. They work with `player_config.gd` to keep settings persistent between runs. Can be skipped by using the "--skip-intros" launch option.
