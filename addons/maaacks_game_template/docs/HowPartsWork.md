...
- `pause_menu.tscn` is a type of `PopupWindowPanel` with the `pauses_game` flag set to true. It will store the previously focused UI element, and return focus to it when closed.
