...
## Flag to update the content of the text label from the attribution file when ready.
...
## Flag to bold any headers (h1-h6).
...
## Flag to disable reading images from the attribution file.
@export var disable_images : bool = false
## Flag to disable reading URLs from the attribution file.
@export var disable_urls : bool = false
## Flag to disable opening links. For platforms that don't permit linking to other domains.
