...
## Usage
Open up the `project_music_controller.tscn` autoload scene and adjust the *Fade In/Out Duration*.  

Refer to [Blending Music](/addons/maaacks_music_controller/docs/BlendingMusic.md) for more details.
